...
/*------header files and pins corresponding to modules are loaded here----------*/
  ...
  //IPAddress broker(10,8,17,14);
  const char* mqtt_server = "10.8.18.61";
  char *ssidList[] = {"IITMandi_A5 WiFi","IITMandi_WiFi", "IITMandi_Faculty","IITMandi_Faculty(A6)","Xiaomi_462D"};
  char *passList[]={"wifi@iit","wifi@iit","wsd@1357","wsd@1357","sid&mifi"};
